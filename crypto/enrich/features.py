...
def compute_rolling_features(features_list, idx, window, field):
                ...
                for f in features:
                    try:
                        cur.execute(
                            ...
                            "(symbol, timestamp, change_pct, range_pct, body_pct, "
                            "upper_wick_pct, lower_wick_pct, volume_ratio_24h, "
                            "volatility_24h, volatility_7d, change_4h, change_24h, change_7d) "
